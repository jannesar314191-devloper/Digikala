        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled show" id="dashboard" data-parent="#accordionExample">
                    <li class="active">
                        <a href="{{route('Acount.Category.Create')}}">  اضافه کردن دسته بندی </a>
                    </li>
                    <li>
                        <a href="{{route('Acount.Category.CategoryList')}}"> لیست دسته بندی ها</a>
                    </li>
                </ul>
            </li>
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled show" id="dashboard" data-parent="#accordionExample">
                    <li class="active">
                        <a href="{{route('Acount.product.Create')}}">  اضافه کردن محصول  </a>
                    </li>
                    <li>
                        <a href="{{route('Acount.Product.ProductList')}}"> لیست  محصولات</a>
                    </li>
                </ul>
            </li>
            <li class="menu">
