                            ...
                            <table id="style-3" class="table style-3  table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">عکس های محصول</th>
                                        <th class="text-center">رنگ های محصول</th>
                                    </tr>
                                </thead>
                                <tbody>
                                  @foreach($products as $product)
                                    ...
                                    <tr>
                                        ...
                                        <li style="margin-bottom: 8px;"><a href="{{route('Acount.Product.ProductAddPicture',$product->id)}}" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="افزودن عکس برای محصول">
                                        ...
                                        <li style="margin-bottom: 8px;"><a href="{{route('Acount.Product.ProductAddColor',$product->id)}}" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="افزودن رنگ محصول">
                                                    <!-- https://feathericons.dev/?search=download&iconset=feather -->
                                                 <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="14" height="14" class="main-grid-item-icon" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                                                   <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
                                                   <polyline points="7 10 12 15 17 10" />
                                                ...
                                                <li><a href="{{route('Acount.Product.ProductColorList')}}" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="مشاهده رنگ محصول">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="14" height="14" class="main-grid-item-icon" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                                                   <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" />
                                                   <circle cx="12" cy="12" r="3" />
                                                 </svg>
